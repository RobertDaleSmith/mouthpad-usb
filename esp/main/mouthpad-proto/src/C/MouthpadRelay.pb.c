...
PB_BIND(mouthware_message_ClearFirmwareCacheWrite, mouthware_message_ClearFirmwareCacheWrite, AUTO)
...
PB_BIND(mouthware_message_ClearFirmwareCacheResponse, mouthware_message_ClearFirmwareCacheResponse, AUTO)
